...
class AgingReport extends Component
{
    ...
    {
        $result = app(ReceivableService::class)->aging($this->asOf);
    ...
    public function render(ReceivableService $receivables): View
    {
        ...
        return view('livewire.sales.aging-report', [
            'result' => $receivables->aging($this->asOf),
        ]);
    }
}
